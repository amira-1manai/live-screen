        ...
        <form action="" method="POST">
            ...
            <div class="form">
                    ...
                    <br>
                        ...
                        <input type="int" name="score" id="score">
                    <br>
                        <label for="nbre_votants">nbre_votants:
                        </label>
                    
                        <input type="int" name="nbre_votants" id="nbre_votants">
                    <br>
                    ...
                    <br> <br>
                        ...
                        <input type="text" name="qualite" id="qualite" >
                    <br> <br>
                        <label for="img">img:
                        </label>
...
//    alert("Please Enter valid titre");
