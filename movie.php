...
<!-- Mirrored from themebeyond.com/html/movflx/movie.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Apr 2022 00:53:04 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <div class="col-lg-6">
                            <div class="movie-page-meta">
                                <div class="tr-movie-menu-active text-center">
                                    ...
                                    <button class="" data-filter=".cat-one">Drama</button>
                            ...
                            <div class="movie-item movie-item-three mb-50">
                                <div class="movie-poster">
                                    ...
                                    <ul class="overlay-btn">
                                        ...
                                        <li><a href="movie-details.php?id=<?php echo $film['idf']; ?>" class="btn">Details</a></li>
                                    </ul>
                                </div>
                                <div class="movie-content">
                                    <div class="top">
                                        <h5 class="title"><a href="movie-details.php?id=<?php echo $film['idf']; ?>><?php echo $film['titre']; ?></a></h5>
                                        <span class="date"><?php echo $film['Date_sortie']; ?></span>
                                    </div>
                                    <div class="bottom">
                                        <ul>
                                            <li><span class="quality"><?php echo $film['qualite']; ?></span></li>
                                            <li>
                                                <span class="duration"><i class="far fa-clock"></i> <?php echo $film['duree']; ?></span>
                                                <span class="rating"><i class="fas fa-thumbs-up"></i> <?php echo $film['nbre_votants']; ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<!-- Mirrored from themebeyond.com/html/movflx/movie.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Apr 2022 00:53:05 GMT -->
</html>
