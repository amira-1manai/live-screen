...
<?php
    ...
    $filmC = new FilmC();
    $film = $filmC->recupererfilm($_GET['id']);
...
<!-- Mirrored from themebeyond.com/html/movflx/movie-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Apr 2022 00:53:05 GMT -->
<head>
        <meta charset="utf-8">
                                        ...
                                        <ul class="navigation">
                                            ...
                                            <li class="active menu-item-has-children"><a href="#">Movie</a>
                                                <ul class="submenu">
                                                    ...
                                                    <li class="active"><a href="movie-details.php">Movie Details</a></li>
                                                </ul>
                                            </li>
                    ...
                    <div class="row align-items-center position-relative">
                        <div class="col-xl-3 col-lg-4">
                            <div class="movie-details-img">
                                <img style="width: 300px;"src="<?php echo $film['image']; ?>" alt="">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="movie-details-content">
                                ...
                                <h2> <span><?php echo $film['titre']; ?></span></h2>
                                <div class="banner-meta">
                                    <ul>
                                        <li class="quality">
                                            <span><?php echo $film['qualite']; ?></span>
                                        </li>
                                        <li class="category">
                                            <a href="#"><?php echo $film['categorie']; ?></a>
                                            
                                        </li>
                                        <li class="release-time">
                                            <span><i class="far fa-calendar-alt"></i> <?php echo $film['Date_sortie']; ?></span>
                                            <span><i class="far fa-clock"></i> <?php echo $film['duree']; ?></span>
                                        </li>
                                    </ul>
                                </div>
...
<!-- Mirrored from themebeyond.com/html/movflx/movie-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Apr 2022 00:53:07 GMT -->
</html>
